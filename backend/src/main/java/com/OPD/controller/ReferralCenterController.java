...
public class ReferralCenterController {
	...
	@GetMapping
	public ResponseEntity<Page<ReferralCenter>> getAllReferralCenters(@RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "10") int size, @RequestParam(defaultValue = "") String search){
		Page<ReferralCenter> referralCenters=service.getAllReferralCenters(page,size,search);
